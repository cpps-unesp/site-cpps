...
<div style="text-align: center; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    <a href="http://lattes.cnpq.br/3505849964932313" target="_blank" title="Currículo Lattes">
      <img src="/imagens/logos/lattes_icon.svg" width="40" alt="Lattes">
    </a>
    <a href="https://scholar.google.com.br/citations?hl=pt-BR&user=UFsVIxQAAAAJ" target="_blank" title="Google Scholar">
      <img src="/imagens/logos/google.png" width="40" alt="Google">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.linkedin.com/in/jaqueline-trevisan-pigatto/?originalSubdomain=br" target="_blank" title="LinkedIn">
      <img src="/imagens/logos/linkedin_icon.svg" width="40" alt="LinkedIn">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.linkedin.com/in/markwd/?locale=pt_BR" target="_blank" title="LinkedIn">
      <img src="/imagens/logos/linkedin_icon.svg" width="40" alt="LinkedIn">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.linkedin.com/in/rafael-augusto-ribeiro-de-almeida-083792137/" target="_blank" title="LinkedIn">
      <img src="/imagens/logos/linkedin_icon.svg" width="40" alt="LinkedIn">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.github.com/" target="_blank" title="GitHub">
      <img src="/imagens/logos/github-icon.svg" width="40" alt="GitHub">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://instagram.com/mel_nakajo?igshid=YmMyMTA2M2Y=" target="_blank" title="Instagram">
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.linkedin.com/in/lauragpereira/" target="_blank" title="LinkedIn">
      <img src="/imagens/logos/linkedin_icon.svg" width="40" alt="LinkedIn">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://twitter.com/arpaschoaleto" target="_blank" title="Twitter">
      <img src="/imagens/logos/logo-cpps-unesp.png" width="40" alt="Twitter">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://github.com/anamacao" target="_blank" title="GitHub">
      <img src="/imagens/logos/github-icon.svg" width="40" alt="GitHub">
    </a>
  </div>
</div>
...
<!-- Julia Lourenço Hora -->
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  <h3 style="margin-bottom: 5px;">Julia Lourenço Hora</h3>
  <p style="margin-top: 0; color: gray;"><em>2023 - atual</em></p>

  <img src="https://i.postimg.cc/htdbgnBb/Imagem-do-Whats-App-de-2023-04-13-s-13-47-05.jpg" width="150" height="150" style="border-radius: 50%; object-fit: cover; margin: 15px auto; display: block;">
...
<!-- Maria Fernanda Furlan -->
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  <h3 style="margin-bottom: 5px;">Maria Fernanda Furlan</h3>
  <p style="margin-top: 0; color: gray;"><em>2023 - atual</em></p>

  <img src="https://i.postimg.cc/xdmssH8Q/Imagem-do-Whats-App-de-2023-04-12-s-21-57-52.jpg" width="150" height="150" style="border-radius: 50%; object-fit: cover; margin: 15px auto; display: block;">
...
<!-- Victória Cristina Marques Guedes -->
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  <h3 style="margin-bottom: 5px;">Victória Cristina Marques Guedes</h3>
  <p style="margin-top: 0; color: gray;"><em>2023 - atual</em></p>

  <img src="https://i.postimg.cc/NF2LTgbd/Imagem-do-Whats-App-de-2023-04-13-s-16-50-08.jpg" width="150" height="150" style="border-radius: 50%; object-fit: cover; margin: 15px auto; display: block;">
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  <h3 style="margin-bottom: 5px;">Victoria dos Anjos Gois</h3>
  <p style="margin-top: 0; color: gray;"><em>2023 - atual</em></p>

  <img src="https://i.postimg.cc/B6MnRj7Y/Imagem-do-Whats-App-de-2023-04-13-s-16-26-52.jpg" width="150" height="150" style="border-radius: 50%; object-fit: cover; margin: 15px auto; display: block;">

  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    <a href="https://www.linkedin.com/in/victoriagois/" target="_blank" title="LinkedIn">
      <img src="/imagens/logos/linkedin_icon.svg" width="40" alt="LinkedIn">
    </a>
    <a href="http://lattes.cnpq.br/8318499711871122" target="_blank" title="Currículo Lattes">
      <img src="/imagens/logos/lattes_icon.svg" width="40" alt="Lattes">
    </a>
  </div>
</div>
