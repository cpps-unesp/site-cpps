...
Utilize _websites_ de exercícios (como os que foram recomendados na [página JS](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/05-exercicios-js)) para se apronfundar nos conhecimentos JQuery.
...
O parâmetro `{params}` define a propriedade CSS a ser animada.
