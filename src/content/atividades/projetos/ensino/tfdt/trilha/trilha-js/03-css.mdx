...
**PRÉ-REQUISITOS PARA FAZER O MÓDULO 1 DO HTML**: Concluir _[Quiz 1](https://forms.gle/giyg5LUv4arh1zP69)_ e _[Exercício Prático 1](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/02-html#exercício-prático)_.
