...
**PRÉ-REQUISITOS PARA FAZER O MÓDULO 2 DO HTML**: Concluir _[Quiz 1](https://forms.gle/giyg5LUv4arh1zP69)_, _[Exercício Prático 1](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/02-html#exercício-prático)_ e o _[Módulo 1 do CSS](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/03-css)_.
...
```
<p>Aprenda <a href="/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/02-html">HTML</a> online.</p>
```
