...
**PRÉ-REQUISITOS PARA COMEÇAR O MÓDULO 3 DO JAVASCRIPT**: Ter concluido o módulo 2 do JavaScript: [Exercícios do Módulo 2 do JS](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/05-exercicios-js#exerc%C3%ADcios-operadores).
