...
Assim como já foi visto na página de [treinamento CSS](/pt/wiki/projetos/ensino/tfdt/trilha/trilha-js/03-css), o Bootstrap pode ser definido como um framework com uma série de arquivos CSS e JS que determinam características específicas e pré-determinadas aos elementos da página.
