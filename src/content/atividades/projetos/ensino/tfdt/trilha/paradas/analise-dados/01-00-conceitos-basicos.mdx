...
O JSON gerado pela trilha de [coleta de dados](/atividades/projetos/ensino/trilha-dados/coleta-dados/05-armazenamento) (ex: `notas_mre.json`) é o ponto de partida natural para análise. A partir desse arquivo, conseguimos:
