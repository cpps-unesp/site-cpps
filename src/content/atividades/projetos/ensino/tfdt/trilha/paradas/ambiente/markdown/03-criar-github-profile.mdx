...
4. Crie um texto de boas vindas, utilize os recursos do Markdown para isso. É possível adicionar imagens, gifs, ajustar o alinhamento e várias outras funções apenas alterando o arquivo README.md do seu repositório. Para saber mais sobre markdown [clique aqui](/pt/wiki/projetos/ensino/tfdt/trilha/paradas/ambiente/markdown/01-nocoes-gerais).
