...
:::tip
Aqui vamos aprender como criar um repositório no GitHub a partir da criação de uma conta e como aplicar a licença MIT ao projeto.
:::
...
Lembre-se: O GitHub é uma das plataformas mais populares para o desenvolvimento de software em todo o mundo e é amplamente utilizado pela comunidade de desenvolvedores❗
