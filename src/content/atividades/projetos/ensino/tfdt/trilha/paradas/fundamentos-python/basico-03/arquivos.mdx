...
```
> Utilisamos o "with" para todo o bloco fechar após sua leitura. Do contrário, seria necessário indicarmos o comando '.close' ao final do código.  
> Fazemos isso pois a codificação pode gerar erros se o arquivo não for fechado  devidamente. Com a instrução With, podemos encapsular o bloco que desejamos abrir e frachar, melhorando a estrutura do código.
