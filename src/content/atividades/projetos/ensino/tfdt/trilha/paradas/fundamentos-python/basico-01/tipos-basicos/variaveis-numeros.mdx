...
Ao executarmos um código, na maioria das vezes, as coisas que escrevermos não vão aparecer diretamente no terminal. Para exibí-las devemos utilizar a ferramenta nativa Print, é a partir dela que podemos exibir os textos, valores e outros tipos de resposta em nossos terminais.
