...
| --- | --- |
| `requests` | Requisições HTTP — ver [coleta](/pt/wiki/projetos/ensino/tfdt/trilha/paradas/coleta-dados/02-requests-bs4) |
...
| `tinydb` | Banco JSON simples — ver [armazenamento](/pt/wiki/projetos/ensino/tfdt/trilha/paradas/coleta-dados/05-armazenamento) |
| `pandas` | Análise de dados — ver [análise](/pt/wiki/projetos/ensino/tfdt/trilha/paradas/analise-dados/01-00-conceitos-basicos) |
...
Para não bagunçar o Python global, crie um ambiente virtual por projeto. Veja a [parada de ambiente](/pt/wiki/projetos/ensino/tfdt/trilha/paradas/ambiente/06-ambiente-virtual) para detalhes.
