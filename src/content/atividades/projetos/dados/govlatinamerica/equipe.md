...
<div style="text-align: center; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="mailto:SEU_EMAIL_AQUI" target="_blank" title="E-mail">
      <img src="/imagens/logos/email.png" width="40" alt="Email">
    </a>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.instagram.com/arddantas/" target="_blank" title="Instagram">
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.instagram.com/net0_pedrosa/" target="_blank" title="Instagram">
      <img src="/imagens/logos/instagram_icon_vermelha.svg" width="40" alt="Instagram">
    </a>
    <a href="https://github.com/HenedioNeto" target="_blank" title="GitHub">
      <img src="/imagens/logos/github-icon.svg" width="40" alt="GitHub">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://github.com/rtosta" target="_blank" title="GitHub">
      <img src="/imagens/logos/github-icon.svg" width="40" alt="GitHub">
    </a>
    <a href="https://www.instagram.com/rebecasantos.tosta/" target="_blank" title="Instagram">
      <img src="/imagens/logos/instagram_icon_vermelha.svg" width="40" alt="Instagram">
    </a>
    <a href="https://gitlab.com/r.s.tosta" target="_blank" title="GitLab">
      <img src="/imagens/logos/logo-cpps-unesp.png" width="40" alt="GitLab">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="https://www.instagram.com/gu.castejon/" target="_blank" title="Instagram">
      <img src="/imagens/logos/instagram_icon_vermelha.svg" width="40" alt="Instagram">
    </a>
  </div>
</div>
...
<div style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; font-size: 18px; flex-wrap: wrap;">
    ...
    <a href="http://lattes.cnpq.br/7001164021728775" target="_blank" title="Currículo Lattes">
      <img src="/imagens/logos/lattes_icon.svg" width="40" alt="Lattes">
    </a>
  </div>
</div>
