...
<div align="center">
 <img src="/imagens/logos/irjournals.png" alt="centered image" width="200" height="300" />
</div>
...
| :--- | :--- | :---: | :--- | :--- |
| Austral | `austral` | ✅ | OJSv2 | não-continua |
| Brazilian Journal of International Relations | `bjir` | ✅ | OJSv3 | não-continua |
| Brazilian Journal of Latin American Studies | `bjlas-prolam` | ✅ | OJSv3 | não-continua |
| Carta Internacional | `carta-inter` | ✅ | OJSv3 | continua |
| Conjuntura Austral | `conj_austral` | ✅ | OJSv2 | não-continua |
| Conjuntura Global | `conj_glob` | ✅ | OJSv2 | continua |
| Conjuntura Internacional | `conj_inter` | ✅ | OJSv3 | não-continua |
| Contexto Internacional | `contexto_inter` | ✅ | scielo | não-continua |
| Estudos Internacionais | `estudos-inter` | ✅ | OJSv3 | não-continua |
| Meridiano 47 | `meridiano` | ✅ | OJSv3 | continua |
| Monções | `moncoes` | ✅ | OJSv3 | não-continua |
| Mural Internacional | `mural_inter` | ✅ | OJSv2 | continua |
| Oikos | `oikos` | ✅ | OJSv2 | não-continua |
| Revista Brasileira de Estudos de Defesa | `rbed` | ✅ | OJSv2 | não-continua |
| Revista Brasileira de Política Internacional | `rbpi` | ✅ | scielo | continua |