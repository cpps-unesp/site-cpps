...
description: Como criar arquivos e organizar a estrutura de conteúdo.
custom_slug:
  pt: criar-arquivo
  en: create-file
  es: crear-archivo
...
Este guia mostra como criar arquivos e organizar pastas para manter a navegação consistente.
