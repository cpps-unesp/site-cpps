---
title: Escrever
description: Como escrever e editar páginas MDX com componentes reutilizáveis.
custom_slug:
  pt: escrever
  en: write
  es: escribir
...
Este guia explica como escrever páginas MDX usando os componentes já padronizados no site.
