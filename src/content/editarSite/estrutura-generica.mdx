...
description: Estrutura reutilizável para criar novas áreas de documentação em MDX.
custom_slug:
  pt: estrutura-generica
  en: generic-structure
  es: estructura-generica
sidebar_order: 1
sidebar_label: Estrutura genérica
---

import Notice from '../../components/atividades/Notice.astro';
import Steps from '../../components/atividades/Steps.astro';

Este guia mostra como replicar a arquitetura de documentação para criar novas seções, como `/manual`.
