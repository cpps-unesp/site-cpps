...
Este guia explica como manter textos e rotas sincronizados entre `pt`, `en` e `es`.
...
O arquivo `src/i18n/routes.ts` define como as rotas (URLs) aparecem em cada idioma.
