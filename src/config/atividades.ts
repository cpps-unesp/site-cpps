    ...
    items: [
      { label: 'Visão Geral', url: '/atividades/projetos/ensino' },
      {
        ...
        items: [
          ...
          {
            label: 'Ambiente',
            url: '/atividades/projetos/ensino/tfdt/trilha/paradas/ambiente/01-intro',
          },
          {
            label: 'Fundamentos',
            url: '/atividades/projetos/ensino/tfdt/trilha/paradas/fundamentos-python/01-intro',
          },
        ],
      },
    ],
    ...
    items: [
      {
        ...
        items: [
          { label: 'Introdução', url: '/atividades/projetos/sistemas/websites/01-intro-md' },
          {
            ...
            url: '/atividades/projetos/sistemas/websites/editar/02-editar-paginas',
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            label: 'Proxmox',
            url: '/atividades/projetos/sistemas/infraestrutura/redes/proxmox/01-intro',
          },
        ],
      },
    ],
